  ...
  return createElementVNode("view", utsMapOf({
    ...
    createElementVNode("scroll-view", utsMapOf({
      ...
      createElementVNode("view", utsMapOf({ class: "grid-view" }), [
        createElementVNode(Fragment, null, RenderHelpers.renderList(_ctx.names, (name, index, __index, _cached): any => {
          return createElementVNode("view", utsMapOf({
            class: "grid-item",
            key: index
          }), [
...
const GenPagesComponentCanvasCanvasContextStyles = [utsMapOf([["page", padStyleMapOf(utsMapOf([["flex", 1]]))], ["scroll-view", padStyleMapOf(utsMapOf([["flex", 1]]))], ["canvas-element", padStyleMapOf(utsMapOf([["width", "100%"], ["height", 250], ["backgroundColor", "#ffffff"]]))], ["grid-view", padStyleMapOf(utsMapOf([["paddingTop", 10], ["paddingRight", 10], ["paddingBottom", 10], ["paddingLeft", 10], ["flexDirection", "row"], ["flexWrap", "wrap"]]))], ["grid-item", padStyleMapOf(utsMapOf([["width", "50%"], ["paddingTop", 5], ["paddingRight", 5], ["paddingBottom", 5], ["paddingLeft", 5]]))]])]
