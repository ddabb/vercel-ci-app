  ...
  return createElementVNode("scroll-view", utsMapOf({
    ...
    createElementVNode("view", utsMapOf({ class: "uni-padding-wrap uni-common-mt" }), [
      createElementVNode("view", utsMapOf({ class: "uni-title" }), [
        createElementVNode("text", utsMapOf({ class: "uni-title-text" }), "图片路径示例")
      ]),
      ...
      createElementVNode("view", null, [
        createElementVNode("text", utsMapOf({ class: "uni-subtitle-text" }), "非static目录的src静态路径：./logo.png"),
        createElementVNode("view", utsMapOf({
          class: "uni-center",
          style: normalizeStyle(utsMapOf({"background":"#FFFFFF"}))
        }), [
...
const GenPagesComponentImageImagePathStyles = [utsMapOf([["image", padStyleMapOf(utsMapOf([["marginTop", 20], ["marginRight", "auto"], ["marginBottom", 20], ["marginLeft", "auto"], ["width", 100]]))]])]
