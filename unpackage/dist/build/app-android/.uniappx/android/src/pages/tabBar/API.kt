...
open class GenPagesTabBarAPI : BasePage {
    ...
    override fun `$render`(): Any? {
        ...
        return createElementVNode("scroll-view", utsMapOf("style" to normalizeStyle(utsMapOf("flex" to "1")), "enable-back-to-top" to "true"), utsArrayOf(
            createElementVNode("view", utsMapOf("class" to "uni-container"), utsArrayOf(
                                    ...
                                    createElementVNode(Fragment, null, RenderHelpers.renderList(menuItem.items, fun(childMenuItem, __key, __index, _cached): Any {
                                        return createElementVNode(Fragment, utsMapOf("key" to childMenuItem.id), utsArrayOf(
                                            if (childMenuItem.items.length == 0) {
                                                createElementVNode("view", utsMapOf("key" to 0, "style" to normalizeStyle(utsMapOf("padding-left" to "18px")), "class" to normalizeClass(utsMapOf("uni-navigate-item" to (childMenuItem.path !== "set-tab-bar" || _ctx.windowWidth <= 768))), "hover-class" to "is--active", "onClick" to fun(){
                ...
                if (isTrue(!_ctx.hasLeftWin)) {
                    createElementVNode("view", utsMapOf("key" to 2, "ref" to "pop", "onClick" to fun(){
                        _ctx.hidePop();
                    }, "class" to "popup"), utsArrayOf(
                        createElementVNode("view", utsMapOf("style" to normalizeStyle(utsMapOf("width" to "90%", "background-color" to "white")), "onClick" to withModifiers(_ctx.stopClickPop, utsArrayOf(
                            "stop"
                        ))), utsArrayOf(
    ...
    override fun data(): Map<String, Any?> {
        return utsMapOf("menu" to menu1 as UTSArray<MenuItem>, "arrowRightIcon" to "/static/icons/arrow-right.png", "hasLeftWin" to computed<Boolean>(fun(): Boolean {
    ...
    companion object {
        ...
        val styles0: Map<String, Map<String, Map<String, Any>>>
            get() {
                return utsMapOf("item" to padStyleMapOf(utsMapOf("marginBottom" to 12)), "popup" to padStyleMapOf(utsMapOf("position" to "fixed", "top" to 0, "bottom" to 0, "left" to 0, "right" to 0, "alignItems" to "center", "justifyContent" to "center", "display" to "none", "backgroundColor" to "rgba(16,16,16,0.5)")));
            }
