        ...
        return createElementVNode(Fragment, null, utsArrayOf(
            ...
            createElementVNode("view", utsMapOf("class" to "uni-common-mt"), utsArrayOf(
                ...
                createElementVNode("view", utsMapOf("class" to "uni-padding-wrap"), utsArrayOf(
                    ...
                    createElementVNode("view", utsMapOf("class" to "uni-btn-v"), utsArrayOf(
                        createVNode(_component_navigator, utsMapOf("url" to "/pages/API/get-window-info/window-area"), utsMapOf("default" to withSlotCtx(fun(): UTSArray<Any> {
                            return utsArrayOf(
                                createElementVNode("button", utsMapOf("type" to "primary"), "窗口各区域示例")
                            );
                        }
                        ), "_" to 1))
                    ))
