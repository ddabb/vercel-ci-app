...
open class GenPagesComponentScrollViewRefreshBoxRefreshBox : VueComponent {
    ...
    companion object {
        ...
        val styles0: Map<String, Map<String, Map<String, Any>>>
            get() {
                return utsMapOf("refresh-box" to padStyleMapOf(utsMapOf("justifyContent" to "center", "alignItems" to "center", "flexDirection" to "row", "width" to "100%", "height" to 30)), "refresh-icon" to padStyleMapOf(utsMapOf("width" to 20, "height" to 20, "marginTop" to 5, "marginRight" to 5, "marginBottom" to 5, "marginLeft" to 5)), "tip-text" to padStyleMapOf(utsMapOf("color" to "#888888", "fontSize" to 12)));
            }
        var inheritAttrs = true;
        var inject: Map<String, Map<String, Any?>> = utsMapOf();
        var emits: Map<String, Any?> = utsMapOf();
        var props = normalizePropsOptions(utsMapOf("state" to utsMapOf("type" to "Number", "default" to 0)));
